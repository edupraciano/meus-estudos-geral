""" Ex.29 O Sr. Manoel Joaquim possui uma grande loja de artigos de R$ 1,99, com cerca de 10 caixas. Para agilizar o
...
Lojas Quase Dois - Tabela de preços 1
    1 > R$ 1.99
    2 > R$ 3.98
    ...
    50 > R$ 99.50"""

total_produtos = int(input('Qual a quantidade de produtos comprados? '))
for i in range(total_produtos):
    print(f'Para {i + 1} Produto > Preço: R$ {(i + 1) * 1.99:.2f}')
