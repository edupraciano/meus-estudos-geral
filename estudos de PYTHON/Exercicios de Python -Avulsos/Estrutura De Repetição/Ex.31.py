""" Ex.31 O Sr. Manoel Joaquim expandiu seus negócios para além dos negócios de 1,99 e agora possui uma loja de
...
que o cliente forneceu, para então calcular e mostrar o valor do troco. Após esta operação, o programa deverá voltar
...
valor_dinheiro = float(input(f'\nQuanto o Cliente pagou em dinheiro? '))
