""" Ex.14 João Papo-de-Pescador, homem de bem, comprou um microcomputador para controlar o rendimento diário de seu
...
excesso = peso - 50
multa = excesso * 4
print(f'Para um total de {peso} kg de peixe, temos um excesso de {excesso}kg além do preestabelecido, portanto,'
      f'precisará pagar uma multa de R$ {multa:.2f}.')
